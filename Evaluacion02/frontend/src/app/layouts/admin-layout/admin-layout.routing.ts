...
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'nuevoasistente', component: NuevoAsistenteComponent},  
    { path: 'nuevoasistente/:id', component: NuevoAsistenteComponent },
    { path: 'nuevaconferencia', component: NuevaConferenciaComponent},
    { path: 'nuevaconferencia/:id', component: NuevaConferenciaComponent}
];
