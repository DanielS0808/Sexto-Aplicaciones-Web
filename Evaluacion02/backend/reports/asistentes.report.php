...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(0, 15, 'Reporte de Asistentes', 0, 1, 'C', true);
    ...
    function TablaAsistentes($header, $data) {        
...
$pdf->AliasNbPages();
$pdf->AddPage();
$header = array('ID', 'Nombre', 'Apellido', 'Email', 'Telefono');
...
$pdf->TablaAsistentes($header, $asistentes);
$pdf->Output();
?>